...
from hypercomplex_layers import QuaternionConv
...
def qresnet20(channels, n):
    return QResNet(BasicBlock, [3, 3, 3], num_classes=10, channels=channels)

def qresnet20large(channels, n):
    return QResNetLarge(BasicBlock, [3, 3, 3], num_classes=10, channels=channels)
...
def qresnet56(channels, n):
    return QResNet(BasicBlock, [9, 9, 9], num_classes=10, channels=channels)


def qresnet110():
    return QResNet(BasicBlock, [18, 18, 18])

def qresnet110large(channels, n):
    return QResNetLarge(BasicBlock, [18, 18, 18], num_classes=100, channels=channels)
