...
def spectrum_fast(x, nperseg=512, noverlap=128, window='hamming', cut_dc=True,
                  output_phase=True, cut_last_timeframe=True, normalize=True):
    '''
...
def gen_submission_list_task2(sed, doa=None, max_loc_value=2.,num_frames=600, num_classes=14, max_overlaps=3):
    '''
    ...
    for i, c in enumerate(sed):  #iterate all time frames
